...
| `scope` | string[] | yes | What is in scope, one bullet each |
| `summary` | string | yes | One or two paragraphs on the problem and the approach |
| `timeline` | object{duration, phase}[] | yes | Phases and their durations, rendered as a table |
