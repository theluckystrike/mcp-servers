...
**In the [official MCP Registry](https://registry.modelcontextprotocol.io/v0.1/servers/io.github.theluckystrike%2Famortization/versions/latest)** (`io.github.theluckystrike/amortization`).
