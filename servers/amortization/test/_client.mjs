// Shared stdio JSON-RPC client for the mcp-amortization suites.
...
export function storeDir(dataHome) { return join(dataHome, "mcp-servers", "amortization"); }

/**
 * The worked loan every unit assertion is recomputed from by hand:
 * 1,000,000 minor units at a nominal 12 percent compounded monthly, paid monthly over
 * 12 periods on the annuity method, drawn down 2026-01-15.
 */
export const WORKED = {
  name: "Worked annuity",
