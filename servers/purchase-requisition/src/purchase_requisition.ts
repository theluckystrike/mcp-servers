/**
 * The purchase-requisition engine: templates, runs, and the progress arithmetic.
 *
 ...
 * the list it started with. That is not a caching convenience: a purchase-requisition somebody ticked
...
/** A section is a heading within one purchase-requisition. Same discipline, but the case is kept. */
 ...
 * purchase-requisition reports 100 percent for a job where half the steps were skipped.
 */
