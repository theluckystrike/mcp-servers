// Shared stdio JSON-RPC client for the mcp-mileage-log suites.
...
export function storeDir(dataHome) { return join(dataHome, "mcp-servers", "mileage-log"); }

/**
 * The worked drive: 12.5 miles to a client site and the US federal business rate of
 * 0.70 USD a mile from 2026-01-01. Dates in the past so the suite cannot depend on the
 * day it runs.
 */
export const RATE = { jurisdiction: "US federal", category: "business", rate: 0.70, unit: "miles", currency: "USD", effective_from: "2026-01-01" };
export const TRIP = { date: "2026-03-09", from: "Home office", to: "Client site, 2 Mill Lane", distance: 12.5, unit: "miles", purpose: "Site visit for the Kowalski refit", category: "business" };
