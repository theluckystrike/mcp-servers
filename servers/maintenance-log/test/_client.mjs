// Shared stdio JSON-RPC client for the mcp-maintenance-log suites.
...
export function storeDir(dataHome) { return join(dataHome, "mcp-servers", "maintenance-log"); }

/**
 * The worked asset: a combi boiler with a serial, serviced in the past so the suite
 * cannot depend on the day it runs. 12,000 cents of work, next service in 365 days.
 */
export const ASSET = { name: "Combi boiler", tag: "SN-88-4412", location: "14 Nowa Street, flat 3", currency: "EUR" };
export const WORK = { date: "2026-03-09", work: "Annual service and safety check", cost_cents: 12000, technician: "Acme Heating Ltd", interval_days: 365 };
