# Installing mcp-onboarding (agent instructions)
...
Server: **Checklist** (@theluckystrike/mcp-onboarding)
...
```sh
npx -y @theluckystrike/mcp-onboarding
```
...
cd mcp-servers
npm install
npm run build --workspace @theluckystrike/mcp-onboarding
```
