...
| `invoice_create` | Create an invoice from line items; allocates the next number, computes discount, tax per rate and total |
...
| `overdue_report` | Unpaid invoices past due, days overdue, outstanding totals per currency (Pro) |
