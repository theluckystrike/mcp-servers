// Shared stdio JSON-RPC client for the mcp-job-card suites.
...
export function storeDir(dataHome) { return join(dataHome, "mcp-servers", "job-card"); }

/**
 * The worked job: a consumer unit replacement for Kowalski, EUR rates.
 * 7.5 hours at 4,500 cents an hour is 33,750 cents; 1 consumer unit at 18,999 is 18,999.
 * Dates are in the past so the suite cannot depend on the day it runs.
 */
export const JOB = {
  client: "Kowalski bathroom refit",
  site: "14 Nowa Street, flat 3",
  description: "Replace the consumer unit and certify",
  currency: "EUR",
  scheduled_date: "2026-03-09",
};
export const LABOR = { worker: "Anna", date: "2026-03-09", hours: 7.5, rate_cents: 4500, note: "First fix, new unit" };
export const LABOR_VALUE_CENTS = 33750;
export const MATERIAL = { item: "Consumer unit, 10-way RCBO", date: "2026-03-09", qty: 1, unit_cost_cents: 18999 };
export const MATERIAL_VALUE_CENTS = 18999;
