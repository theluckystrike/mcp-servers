...
| `price_history` | List the stored observations for one watch, newest last, each with its price, currency, source and extraction confidence. Free shows the last 30. |
...
| `id` | string | no | Watch id or URL. Omit and set all=true to refresh everything. |
