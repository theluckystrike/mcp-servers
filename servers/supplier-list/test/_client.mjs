// Shared stdio JSON-RPC client for the mcp-supplier-list suites.
...
export function storeDir(dataHome) { return join(dataHome, "mcp-servers", "supplier-list"); }

/**
 * The worked supplier: a packaging vendor, EUR terms. Dates are handled by the tools
 * themselves (today defaults), so the suite cannot depend on the day it runs.
 */
export const BOX = {
