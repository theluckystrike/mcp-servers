...
export const PRODUCTS = {
  ...
  bundle: { desc: "Every server above, one key, lifetime. Saves $284 against buying seventeen.", free: "", pro: "", name: "MCP Servers Bundle (all servers, lifetime)", price: "price_1UBDU9JKCamubEm1dWgRjtoW", usd: 39, pkg: null, bin: null, payload: "*" },
};
