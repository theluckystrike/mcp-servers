...
const VARIANT_ALIASES: Record<string, string> = {
  ...
  "convert-pdf-to-word-docx": "pdf",
  "pdf-to-word": "pdf",
  "subscription-manager-track-renewals": "recurring",
  "meeting-notes-transcript-summary": "docx",
  "study-flashcards-exam-prep": "kanban",
  "career": "resume",
  "cashflow": "bank-statement",
  "credit-note": "billing-docs",
  "credit-note-ics": "credit-note",
  "credit-memo": "credit-note",
  "delegacja": "per-diem",
  "dunning": "statement-of-account",
  "fixed-assets": "asset-register",
  "freelance": "quotes",
  "imprest-account": "petty-cash",
  "lease-schedule": "amortization",
  "letterhead": "docx",
  "deposits-retainer": "deposits",
  "resume-builder-ats-checker": "resume",
  "cv-maker-resume-templates": "resume",
  "invoice-generator-freelancers": "invoice",
  "time-tracking-billing-hours": "time-tracker",
  "receipt-expense-scanner-reports": "expense-tracker",
  "price-drop-alert-tracker": "price-tracker",
  "task-board-todo-kanban": "kanban",
  "pdf-split-merge-compress": "pdf",
  "delivery-milestones": "delivery-schedule",
  "packing-slip": "packing-list",
  "milestone-schedule": "delivery-schedule",
  "onboarding-checklist-inspection-runs": "checklist",
  "packing-slip-cartons-shipment-weights": "packing-list",
  "pivot": "spreadsheet",
  "purchase-order": "billing-docs",
  "rate-card": "catalogue",
  "scheduling": "timezone",
