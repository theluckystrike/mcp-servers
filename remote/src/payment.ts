 ...
 */
export function paymentDescriptor(i: PaymentDescriptorInput): Record<string, unknown> {
  ...
  return {
    ...
    agent_settleable_reason:
      "This server has no agent-settleable payment rail. Payment is a card checkout a person completes in a browser. " +
