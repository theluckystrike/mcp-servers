// GENERATED by remote/build-vendor.mjs from servers/catalogue/src/index.ts. Do not edit.
...
import { currencyDecimals, formatMoney, type Business } from "../invoice/lib.js";
...
server.registerTool("price_list_text", {
  ...
  description: "Print the price list as plain text: every SKU with the price in force on a date, per currency and tier, with the valid-from date and any later price already booked, then the labour rates. The same text also comes back as a .txt download link valid for one hour. Free.",
  inputSchema: {
