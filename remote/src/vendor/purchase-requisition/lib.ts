/**
 * The purchase-requisition engine, as a stable public API for other servers in this repo.
 *
 ...
 *
 * There is no money here to re-export: a purchase-requisition has no amounts. `today()` and
 ...
 *
 * Stability: the names below are the contract. `@theluckystrike/mcp-purchase-requisition/dist/*.js`
