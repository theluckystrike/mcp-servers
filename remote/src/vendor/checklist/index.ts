// GENERATED by remote/build-vendor.mjs from servers/checklist/src/index.ts. Do not edit.
  ...
  try {
    ...
    if (a.out_path === undefined) {
      return json({
        ...
        ...(gate.isPro() ? {} : { pro_note: `Pass out_path to get this report back as a .txt download link valid for one hour. ${gate.upgradeText("Writing the run report to a file", "run_report")}` }),
        basis: BASIS,
      });
    }
