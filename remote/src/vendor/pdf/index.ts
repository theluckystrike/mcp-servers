// GENERATED by remote/build-vendor.mjs from servers/pdf/src/index.ts. Do not edit.
import { registerPdfUpload } from "../../shims/pdf-upload.js";
import { publishFile } from "../../shims/fs.js";
import { randomBytes } from "node:crypto";
import { statSync, writeFileSync } from "../../shims/fs.js";
 ...
 */
function sanitizeStampText(s: string): { text: string; removed: number; transliterated: number } {
...
server.registerTool("pdf_merge", {
  ...
  inputSchema: {
    ...
    out_path: z.string().describe("Name for the merged PDF; it comes back as a download link valid for one hour"),
...
server.registerTool("pdf_split", {
  ...
  inputSchema: {
    path: z.string().describe("Name of the uploaded PDF to split"),
...
server.registerTool("pdf_pages", {
  ...
  inputSchema: {
    path: z.string().describe("Name of an uploaded PDF (pdf_upload), or one this server wrote earlier"),
    pages: z.string().describe("1-based pages and ranges to keep, in output order, e.g. \"2,4-6\" or \"5,1,1\""),
    out_path: z.string().describe("Name for the extracted PDF; it comes back as a download link valid for one hour"),
...
server.registerTool("pdf_rotate", {
  ...
  inputSchema: {
    ...
    out_path: z.string().describe("Name for the rotated PDF; it comes back as a download link valid for one hour"),
    overwrite: z.boolean().optional().describe("Replace out_path if it exists. Default false"),
  },
}, async (a) => {
  let reservation: Reservation | null = null;
...
server.registerTool("pdf_stamp", {
  ...
  inputSchema: {
    ...
    out_path: z.string().describe("Name for the stamped PDF; it comes back as a download link valid for one hour"),
    overwrite: z.boolean().optional().describe("Replace out_path if it exists. Default false"),
  },
...
server.registerTool("pdf_watermark_business", {
  ...
  inputSchema: {
    path: z.string().describe("Name of an uploaded PDF (pdf_upload), or one this server wrote earlier"),
    out_path: z.string().describe("Name for the footed PDF; it comes back as a download link valid for one hour"),
    overwrite: z.boolean().optional().describe("Replace out_path if it exists. Default false"),
...
server.registerTool("pdf_reorder", {
  ...
  inputSchema: {
    ...
    out_path: z.string().describe("Name for the reordered PDF; it comes back as a download link valid for one hour"),
    overwrite: z.boolean().optional().describe("Replace out_path if it exists. Default false"),
  },
}, async (a) => {
  let reservation: Reservation | null = null;
...
server.registerTool("pdf_text", {
  ...
  inputSchema: {
    path: z.string().describe("Name of the PDF to read"),
