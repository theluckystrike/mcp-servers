// GENERATED by remote/build-vendor.mjs from servers/dunning-letters/src/index.ts. Do not edit.
...
function senderNotes(s: Sender): string[] {
  return (s.name ?? "").trim()
    ? []
    : ["The letters are signed \"[Your name]\": the shared business profile has no name. Run business_set {name} on your https://mcp.zovo.one/mcp/invoice endpoint once and every later letter is signed."];
}
