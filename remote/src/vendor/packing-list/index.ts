// GENERATED by remote/build-vendor.mjs from servers/packing-list/src/index.ts. Do not edit.
  ...
  try {
    ...
    if (a.out_path === undefined) {
      return json({
        ...
        ...(gate.isPro() ? {} : { pro_note: `Pass out_path to get this slip back as a .txt download link valid for one hour. ${gate.upgradeText("Writing the packing slip to a file", "packing_slip")}` }),
        basis: BASIS,
      });
    }
