// GENERATED by remote/build-vendor.mjs from servers/statement-of-account/src/index.ts. Do not edit.
...
import { formatMoney, type ComputedLine } from "../invoice/lib.js";
...
server.registerTool("statement_text", {
  ...
  description: "Turn one client's statement into a plain-text ledger with every movement in date order, the opening and closing balances and a sign-off, ready to paste into an email. The same text also comes back as a .txt download link valid for one hour.",
  inputSchema: {
    client: clientArg,
...
server.registerTool("dunning_text", {
  ...
  description: "Write a payment chaser for one client at level 1 friendly, 2 firm or 3 final demand, listing every overdue invoice with its age and total, plus your bank details when the profile has them. The letter also comes back as a .txt download link valid for one hour. Level 3 is Pro.",
  inputSchema: {
    client: clientArg,
