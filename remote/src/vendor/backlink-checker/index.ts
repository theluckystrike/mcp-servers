// GENERATED by remote/build-vendor.mjs from servers/backlink-checker/src/index.ts. Do not edit.
 ...
 */
function extractLinks(html: string): { href: string; rel: string; anchor: string }[] {
...
function classify(link: { href: string; rel: string }, targetHost: string): { linksToTarget: boolean; dofollow: boolean } {
  let host = "";
  try {
...
function pageGuards(html: string): { noindex: boolean; nofollowMeta: boolean } {
