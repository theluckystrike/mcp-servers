...
const WAIVERS = [
  { check: "spec", servers: ["bank-statement", "calendar", "image", "kanban", "pdf"],
    why: "SPEC.md is generated by scripts/gen-spec.mjs, whose CURATED table covers 11 servers; these five need their invariants and storage written by hand first" },
  { check: "contract", servers: ["bank-statement", "calendar", "image", "kanban", "pdf"],
    why: "the contract suite asserts SPEC.md invariants, so it cannot be written before the SPEC; bank-statement, calendar and kanban also lack a test/_client.mjs" },
