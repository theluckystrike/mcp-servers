...
CAPABILITY = {
    ...
    "purchaseRequisition": "purchase requisitions you build once and approve per order, with the signed record of each approval",
    "bill-of-sale": "a bill of sale generator: bills of sale for vehicles, equipment and stock with signature lines",
    "credit-note": "credit notes and credit memos against an invoice or standalone",
    "job-card": "job cards for trades and field service: hours and materials per job",
    "dunning-letters": "dunning letters and overdue invoice payment reminders: reminder, final notice and aging",
    "supplier-list": "a supplier directory that does not rot: contacts, payment terms, lead times and review stamps",
    "service-agreement": "service agreements for freelancers: scope, deliverables, rate, termination and liability, rendered for signing",
    "maintenance-log": "an equipment maintenance log and schedule: service entries, costs, and what is due or overdue",
    "mileage-log": "a mileage log for deductible driving: trips, effective-dated rates, summaries and a CSV export",
    "goods-receipt": "goods receipt notes against purchase orders: units received, damaged and short, with a discrepancy report",
    "leave": "a staff leave and PTO tracker: requests, approvals, balances, who is out and a calendar export",
    "onboarding": "a new-hire onboarding planner: hire records, role templates, task owners and due dates",
    "backlink-checker": "a backlink checker: does a page link to your domain, dofollow or nofollow, anchor text and robots guards",
    "purchase-requisition": "purchase requisitions you build once and approve per order, with the signed record of each approval",
...
SPECIFIC_TOPICS = {
    ...
    "purchaseRequisition": ["purchase-order", "requisition", "approval", "procurement"],
    ...
    "supplier-list": ["supplier-list", "supplier-directory", "vendors", "procurement"],
    "service-agreement": ["service-agreement", "service-contract", "freelance", "contract"],
    "maintenance-log": ["maintenance-log", "maintenance-schedule", "equipment", "service-log"],
    "backlink-checker": ["backlinks", "seo", "link-building", "link-checker", "dofollow"],
    "mileage-log": ["mileage-log", "mileage-logbook", "mileage-tracker", "tax-deduction"],
