...
const kpis = [
  ...
  { cat: "Discovery", name: "Human page views, storefront", value: humanViews7d, target: 500, unit: "views, 7d", how: "data/traffic.json human_evidence, browser user agents confirmed by a render-engine test (did that exact UA ever fetch favicon, cdn-cgi or assets); 33 of 124 browser-shaped UA strings passed", why: "The honest size of the audience. A spoofed UA that never loads an asset is not a person." },
