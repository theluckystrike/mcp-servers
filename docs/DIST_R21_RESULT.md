...
| --- | --- | --- | --- |
| 1 | SERVER_COUNT 27 -> 28 committed | done | 24d0dfd, `packages/mcp-license/src/index.ts` and `remote/src/shims/license.ts`, by path, the number line only, pulled first. Nothing else in that commit |
